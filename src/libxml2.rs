...
///
/// **Empirically Verified** (see libxml2-thread-safety-test project):
...
impl ValidationResult {
    /// Create ValidationResult from libxml2 return code
    pub fn from_code(code: c_int) -> Self {
        match code {
            0 => ValidationResult::Valid,
            n if n > 0 => ValidationResult::Invalid { error_count: n },
...
impl LibXml2Wrapper {
    ...
    pub fn validate_file(
        ...
        unsafe {
            ...
            let result = ValidationResult::from_code(result_code);
...
<root><invalid>content</invalid></root>"#;
    ...
    fn test_validation_result_from_code() {
        assert_eq!(ValidationResult::from_code(0), ValidationResult::Valid);
        assert_eq!(
            ValidationResult::from_code(5),
            ValidationResult::Invalid { error_count: 5 }
        );
        assert_eq!(
            ValidationResult::from_code(-1),
    ...
    fn test_validation_result_predicates() {
        ...
        let invalid = ValidationResult::Invalid { error_count: 1 };
